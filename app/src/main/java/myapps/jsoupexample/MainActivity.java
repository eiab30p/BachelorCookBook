...
//                // Execute Title AsyncTask
        ...
        //write public method here for the <code></code>
//                new Title().execute();
//            }
//        });
//
...
//        });
    ...
    //common ingredient radio button code
    public void search(){
        TextView searchE = (TextView)findViewById(R.id.search_entry);
        String searchEntry = searchE.getText().toString();

        //searchEntry goes into the database query and returns the result


        //Toast.makeText(this, R.string.no_code, Toast.LENGTH_LONG).show();
    }

    //search bar code
    public void setCommonIngredient(){
        Toast.makeText(this, R.string.no_code, Toast.LENGTH_LONG).show();
    }
